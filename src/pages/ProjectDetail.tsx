...
{project.images?.[0] && project.images[0].displayMode === 'centered' && (
      ...
      >
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            {project.externalLink && project.slug !== 'graffiti' && (
      ...
      {/* Graffiti external link at bottom */}
      {project.slug === 'graffiti' && project.externalLink && (
        <section className="py-12">
          <div className="container mx-auto px-4 text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`group inline-flex items-center gap-2 text-sm font-medium transition-colors ${isDark ? 'text-white/60 hover:text-blue-400' : 'text-foreground/60 hover:text-blue-600'}`}
            >
