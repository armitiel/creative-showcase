  ...
  'hubble-rx': {
    pl: {
      ...
      heroFollowImageCaptions: {
        ...
        1: 'Warianty logo — wersja jasna na turkusowym tle i ciemna na białym tle',
    ...
    en: {
      ...
      heroFollowImageCaptions: {
        ...
        1: 'Logo variants — light version on teal background and dark version on white background',
