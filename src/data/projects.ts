...
export const projects: Project[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: '/projects/portal/selling-sheets.png', alt: 'Portal Selling Sheets', caption: 'Materiały sprzedażowe (Selling Sheets) prezentujące ofertę Portal dla retailerów', noMagnifier: true },
    ],
    mobileScreens: {
