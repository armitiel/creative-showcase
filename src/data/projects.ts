...
export const projects: Project[] = [
  ...
  },
  {
    ...
    heroFollowImages: [
      { src: '/projects/hubble/logo-variants.jpg', alt: 'HubbleRx Logo Versions', caption: 'Warianty logo — wersja jasna na turkusowym tle i ciemna na białym tle', displayMode: 'centered', backgroundColor: '#ffffff', imageScale: 0.55 },
  ...
  },
  {
    ...
    thumbnailGrid: {
      ...
      images: [
        { src: '/projects/nft-system/ee.png', alt: 'NFT Character #1' },
        { src: '/projects/nft-system/ee2.png', alt: 'NFT Character #2' },
        { src: '/projects/nft-system/ee4.png', alt: 'NFT Character #3' },
        { src: '/projects/nft-system/ee5.png', alt: 'NFT Character #4' },
        { src: '/projects/nft-system/ee6.png', alt: 'NFT Character #5' },
        { src: '/projects/nft-system/ee7.png', alt: 'NFT Character #6' },
        { src: '/projects/nft-system/ee8.png', alt: 'NFT Character #7' },
        { src: '/projects/nft-system/ee9.png', alt: 'NFT Character #8' },
        { src: '/projects/nft-system/ee10.png', alt: 'NFT Character #9' },
        { src: '/projects/nft-system/ee11.png', alt: 'NFT Character #10' },
      ],
    },
    images: [],
  },
