...
export const projects: Project[] = [
  ...
  },
  {
    ...
    heroFollowImages: [
      { src: '/projects/portal/device-front.png', alt: 'Portal Smart Checkout Device', caption: 'Urządzenie Portal Smart Checkout z kamerą do skanowania twarzy', displayMode: 'centered', imageScale: 0.7 },
