    ...
    extend: {
      ...
      keyframes: {
        ...
        "glitch-1": {
          ...
          "93%": { opacity: "0.25", transform: "translateX(3px)" },
          "95%": { opacity: "0", transform: "translateX(-1px)" },
          "97%": { opacity: "0.2", transform: "translateX(2px)" },
          "99%": { opacity: "0", transform: "translateX(0)" },
        },
        "glitch-2": {
          "0%, 88%, 100%": { opacity: "0", transform: "translateX(0)" },
          "89%": { opacity: "0.2", transform: "translateX(-3px)" },
          "91%": { opacity: "0", transform: "translateX(1px)" },
          "93%": { opacity: "0.25", transform: "translateX(-2px)" },
